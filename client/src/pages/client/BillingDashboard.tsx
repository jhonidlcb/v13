                          ...
                          {method.type === 'card' ? (
                            <div>
                              <p className="font-medium">
                                {method.details?.brand || 'Tarjeta'} terminada en {method.details?.last4 || '****'}
                              </p>
                              <p className="text-sm text-muted-foreground">
                                Vence: {method.details?.expiryDate || 'N/A'}
                              </p>
                            </div>
                          ) : (
                            <div>
                              <p className="font-medium">{method.details?.bankName || 'Banco'}</p>
                              <p className="text-sm text-muted-foreground">
                                Cuenta: {method.details?.accountNumber || '****'}
                              </p>
                            </div>
                          )}
                        </div>
        ...
        <>
          <div>
            ...
            <Input
              ...
              onChange={(e) => setFormData({ ...formData, details: { ...formData.details, holderName: e.target.value } })}
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setFormData({ ...formData, details: { ...formData.details, cardNumber: e.target.value } })}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, details: { ...formData.details, expiryDate: e.target.value } })}
                placeholder="MM/AA"
                required
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, details: { ...formData.details, cvv: e.target.value } })}
                placeholder="123"
                required
              />
            </div>
              ...
              {paymentMethods.map((method) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      {method.type === 'card' ? (
                        <p>{method.details?.brand || 'Tarjeta'} terminada en {method.details?.last4 || '****'}</p>
                      ) : (
                        <p>{method.details?.bankName || 'Banco'} - {method.details?.accountNumber || '****'}</p>
                      )}
                    </div>
                  </div>
                </div>
